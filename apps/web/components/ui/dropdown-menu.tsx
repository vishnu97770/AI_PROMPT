...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-accent data-[state=open]:bg-accent transition-colors",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "data-[state=open]:animate-fade-in-down data-[state=closed]:animate-fade-out-up",
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded-xl border border-border bg-card p-1 shadow-xl",
        "data-[state=open]:animate-fade-in-down data-[state=closed]:animate-fade-out-up",
